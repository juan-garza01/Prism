...
public class PlayerRoom : RoomGenerator
{
    ...
    public List<WeaponPlacementData> weaponData;
        ...
        HashSet<Vector2Int> roomFloorNoCorridors)
    {
        ...
        placedObjects.AddRange(prefabPlacer.PlaceWeapons(weaponData, itemPlacementHelper));
...
[Serializable]
public class WeaponPlacementData : PlacementData
{
    public GameObject weapons;
    public Vector2Int weaponSize = Vector2Int.one;
}
